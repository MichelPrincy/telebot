...
""")
    ...
    async def do_task(self, account_idx, link, action, specific_text=None):
        try:
            ...
            # 1. Ouverture ADB
            os.system(f'{self.adb} shell am start -a android.intent.action.VIEW -d "{link}" -p com.waxmoon.ma.gp /dev/null 2>&1')
...
╚═╝     ╚═╝╚═╝ ╚═════╝╚═╝  ╚═╝{RESET}
{DIM}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{RESET}
{WHITE}🤖 BOT AUTOMATION V3.3.1 (autoconnect) {DIM}|{RESET} {CYAN}BY MICH{RESET}
{DIM}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━{RESET}
 👤 User          : {user_info}
 💳 CashCoin (DB) : {db_cash}
